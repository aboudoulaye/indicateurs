<div class="w-full h-full flex flex-col">
    ...
    <div class="w-90 mt-2 mx-auto" onclick="my_modal_2.showModal()">
        <div class="w-full flex justify-center mt-4" onclick="my_modal_2.showModal()">
            <button class="btn btn-soft btn-warning">Créer Manuellement</button>
        </div>
        @error('name')
            ...
            <div class="modal-box flex flex-col items-center justify-center">
                ...
                <form class="w-full max-w-sm mx-auto mt-4" wire:submit.prevent="save">
                    <fieldset class="fieldset bg-base-200 border-base-300 rounded-box border p-6">
                        <legend class="fieldset-legend text-lg font-semibold">Créer Région</legend>

                        <label class="label mt-2">Nom</label>
                        <input wire:model="name" type="text" pattern="^[A-Z0-9 ]+$"
    ...
    <form wire:submit.prevent="import"
        ...
        <fieldset class="fieldset w-[50%] items-center justify-end mx-auto my-auto">
            <div>
                <legend class="fieldset-legend">Choisir le fichier</legend>
