<div class="w-full h-full flex flex-col">
    ...
    <div
        class="w-90 mt-2 mx-auto text-center border rounded text-3xl font-semibold p-2 hover:border-amber-400 shadow-2xl">
        CREATION DE DISTRICT
    </div>
            ...
            <div class="modal-box flex flex-col items-center justify-center">
                ...
                <form class="w-full max-w-sm mx-auto mt-4" wire:submit.prevent="save">
                    <fieldset class="fieldset bg-base-200 border-base-300 rounded-box border p-6">
                        <legend class="fieldset-legend text-lg font-semibold">Créer District</legend>
                        ...
                        <label class="label mt-2">Nom</label>
                        <input wire:model="name" type="text" pattern="^[A-Z]+$"
                            title="Utilisez uniquement des lettres MAJUSCULES."
    ...
    <div class="w-full h-full mt-20">
        <div class="w-full flex justify-center ">
            <p class="text-xl">IMPORTER DISTRICTS</p>
        </div>
