<div class="w-full h-full flex flex-col">
    ...
    <div
        ...
        LIAISON DE PROGRAMMES/PRODUITS
    </div>
            ...
            <div class="modal-box flex flex-col items-center justify-center">
                ...
                <form class="w-full max-w-sm mx-auto mt-4" wire:submit.prevent="save">
                    <fieldset class="fieldset bg-base-200 border-base-300 rounded-box border p-6">
                        <legend class="fieldset-legend text-lg font-semibold">Lier Programme/produit</legend>
                        <label class="label mt-2 floating-label">
                            <span>Code du Programme</span>
                            <input wire:model="code" type="text" pattern="^[A-Z_-]+$"
                                title="Utilisez uniquement des lettres MAJUSCULES, le tiret (-) et le underscore (_)."
                                class="input input-bordered w-full" placeholder="MERECAGBO" />
                        </label>
                        @error('code')
                        ...
                        <label class="label mt-2 floating-label">
                            ...
                            <input wire:model="name" type="text" pattern="^[A-Z-_ ]+$"
                                title="Utilisez uniquement des lettres MAJUSCULES." class="input input-bordered w-full"
                                placeholder="Ex: AGNEBY TIASSA" />
                        </label>
                        @error('name')
                            <span class="text-red-600 mb-1 text-center block">{{ $message }}</span>
                        @enderror
    ...
    <div class="w-full h-full mt-20">
        <div class="w-full flex justify-center ">
            <p class="text-xl font-semibold">LIER PROGRAMMES/PRODUITS</p>
        </div>
        <form wire:submit.prevent="import"
            ...
            <fieldset class="fieldset w-[50%] items-center  justify-end mx-auto my-auto">
                ...
                <div>
                    <legend class="fieldset-legend">Fichier produits/programmes</legend>
