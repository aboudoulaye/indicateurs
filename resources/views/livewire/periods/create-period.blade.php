<div class="w-full h-full flex flex-col">
    ...
    <div
        ...
        PERIODE D'ENREGISTREMENET
    </div>


    <form class="w-1/2  mx-auto mt-15 border-t-2 shadow-2xl" wire:submit.prevent="save">
        <fieldset class="fieldset bg-base-200 border-base-300 rounded-box border p-6">
            <legend class="fieldset-legend text-lg font-semibold">DEFINIR UNE PERIODE D'ENREGISTREMENT</legend>

            <label class="label mt-2 w-full">Periode</label>
