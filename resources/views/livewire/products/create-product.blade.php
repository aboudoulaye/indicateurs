<div class="w-full h-full flex flex-col">
    ...
    <div class="w-90 mt-2 mx-auto" onclick="my_modal_2.showModal()">
        ...
        <dialog id="my_modal_2" class="modal" wire:ignore.self>
            <div class="modal-box flex flex-col items-center justify-center">
                ...
                <form class="w-full max-w-sm mx-auto mt-4" wire:submit.prevent="save">
                    <fieldset class="fieldset bg-base-200 border-base-300 rounded-box border p-6">
                        <legend class="fieldset-legend text-lg font-semibold">Créer produits</legend>
                        <label class="label mt-2 floating-label">
                            <span>Code du Produit</span>
                            <input wire:model="code" type="text" pattern="^[0-9]+$"
                                title="Utilisez uniquement des chiffres." class="input input-bordered w-full"
                                placeholder="0123456" />
                        </label>
                        @error('code')
                        ...
                        <label class="label mt-2 floating-label">
                            ...
                            <input wire:model="name" type="text" class="input input-bordered w-full"
                                pattern="^[A-Za-z0-9\- ]+$"
                                title="Utilisez uniquement des lettres sans accents, chiffres, espaces et tirets."
                                placeholder="PARACETAMOL 500 MG COMPRIME " />
                        </label>
                        @error('name')
                            <span class="text-red-600 mb-1 text-center block">{{ $message }}</span>
                        @enderror

                        <label class="label mt-2 floating-label">programme du Produit</label>
                        <select class="select js-example-matcher-start select2-results__options w-full"
                            wire:model="program_id">
                            <option value="">choisir program</option>
    ...
    <div class="w-full h-full mt-20">
        <div class="w-full flex justify-center ">
            <p class="text-xl font-semibold">IMPORTER PRODUITS SANTE</p>
        </div>
        <form wire:submit.prevent="import"
            ...
            <fieldset class="fieldset w-[50%] items-center  justify-end mx-auto my-auto">
                ...
                <div>
                    <legend class="fieldset-legend">Fichier produits</legend>
