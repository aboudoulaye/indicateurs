<div class="w-full h-full flex flex-col">
    ...
    <div
        ...
        LIER PROGRAMMES/ETABLISSEMENTS
    </div>
            ...
            <div class="modal-box flex flex-col items-center justify-center">
                ...
                <form class="w-full max-w-sm mx-auto mt-4" wire:submit.prevent="save">
                    <fieldset class="fieldset bg-base-200 border-base-300 rounded-box border p-6">
                        <legend class="fieldset-legend text-lg font-semibold">Lier Programmes/Centres</legend>
                        ...
                        <select class="select js-example-matcher-start select2-results__options w-full"
                            ...
                            <option value="">choisir du Programme</option>
                        ...
                        <label class="label mt-2">Nom du Centre</label>
                        <select class="select js-example-matcher-start select2-results__options w-full"
    ...
    <div class="w-full h-full mt-20">
        <div class="w-full flex justify-center ">
            <p class="text-xl font-semibold">LIER PROGRAMMES/ETABLISSEMENST</p>
        </div>
        <form wire:submit.prevent="import" enctype="multipart/form-data"
            ...
            <fieldset class="fieldset w-[50%] items-center  justify-end mx-auto my-auto">
                ...
                <div>
                    <legend class="fieldset-legend">Fichier etablissements-programmes</legend>
                    ...
                    <input id="file-upload" type="file" wire:model="file" class="file-input h-12 w-full hidden" aria-label="Fichier à importer" />
