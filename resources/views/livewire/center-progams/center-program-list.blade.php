    ...
    <div class="bg-base-100 rounded-xl shadow-md p-4 mt-4 w-full">
        ...
        <div class="flex flex-wrap justify-between items-center mb-4 gap-2">
            <span class="badge badge-warning font-semibold p-3">
                LISTE DES ETABLISSEMENTS/PROGRAMMES
            </span>
            ...
            <div class="overflow-x-auto">
                <table class="table table-zebra w-full">
                    <thead>
                        <tr>
                            <th class="w-[20%]">Id</th>
                            <th class="w-[40%]">Etablissements</th>
                            <th class="w-[20%]">Programmes</th>
                            <th class="w-[20%] text-right">Actions</th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($centerprogrammes as $centerprogramme)
                            <tr wire:key="{{ $centerprogramme->id }}" class="hover:bg-base-200">
                                <td>{{ $i++ }}</td>
                                <td>
                                    ...
                                    @else --}}
                                        <div class="flex items-center gap-2">
                                            ...
                                            {{ $centerprogramme->center->name }}
                                        </div>
                                        {{-- @endif --}}
                                </td>
                                <td>

                                    {{ $centerprogramme->program->name }}
                                ...
                                <td class="text-right">
                                    <div class="flex justify-end gap-2">
                                        ...
                                        @else --}}
                                            ...
                                            <button
                                                onclick="if(confirm('Êtes-vous sûr de supprimer la liaison ?')) { @this.delete({{ $centerprogramme->center_id }}, {{ $centerprogramme->program_id }}) }"
                                                class="btn btn-ghost btn-square">
                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
