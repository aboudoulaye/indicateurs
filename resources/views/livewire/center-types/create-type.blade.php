<div class="w-full h-full flex flex-col">
    ...
    <div
        ...
        CREATION TYPE D'ETABLISSEMENTS
    </div>

    <div class="w-90 mt-2 mx-auto" onclick="my_modal_2.showModal()">
        <div class="w-full flex justify-center mt-4" onclick="my_modal_2.showModal()">
            ...
            <div class="modal-box flex flex-col items-center justify-center">
                ...
                <form class="w-full max-w-sm mx-auto mt-4" wire:submit.prevent="save">
                    <fieldset class="fieldset bg-base-200 border-base-300 rounded-box border p-6">
                        <legend class="fieldset-legend text-lg font-semibold">Créer Type Etablissement</legend>

                        <label class="label mt-2">Nom</label>
                        <input wire:model="name" type="text" pattern="^[A-Z_-/. ]+$"
                            title="Utilisez uniquement des lettres MAJUSCULES, (.) , (_), (-) et espace."
                            class="input input-bordered w-full" placeholder="Ex: ARV. PNS" />
    ...
    <form wire:submit.prevent="import"
        class="w-[50%] h-[40%] mx-auto mt-30 flex shadow-2xl border-t-5 border-t-green-800">
        <fieldset class="fieldset w-[50%] items-center justify-end mx-auto my-auto">
            <div>
                <legend class="fieldset-legend">Choisir le fichier type</legend>
                <label for="file-upload"
                    ...
                    <span class="text-blue-600 items-end">Choisir un fichier type</span>
                </label>
